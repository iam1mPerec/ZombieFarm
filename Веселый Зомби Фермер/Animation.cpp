...
animation::animation(char** M, field& MField, events_list& List, resources& res, DialogBox &dial):
Dial(dial),
list(List),
Res(res),
x1(0),
...
void animation::startCollecting(farmer* Farmboy)
{
    farmboy = Farmboy;
    tsup = action::gather;
    firstrun = true;
...
void animation::startPlanting(const int X1, const int X2, const int Y1, const int Y2, enum plants Plant, farmer* Farmboy)
{
    farmboy = Farmboy;
    x1 = X1;
    x2 = X2;
